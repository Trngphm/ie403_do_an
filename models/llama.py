...
class LlamaLLM(BaseLLM):
    ...
    def build_prompt(self, text):
        ...
        # Llama 3 cũng dùng apply_chat_template như Qwen
        messages = [
        ...
        return self.tokenizer.apply_chat_template(
            messages,
            tokenize=False,
            add_generation_prompt=True   # tự thêm <|start_header_id|>assistant<|end_header_id|>
        )
    ...
    def generate(self, prompt):
        ...
        outputs = self.model.generate(
            **inputs,
            ...
            eos_token_id=self.tokenizer.eos_token_id,  # Llama 3 cần explicit để dừng đúng
        )
